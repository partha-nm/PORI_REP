...
export default function QuestionEntry(props) {
  ...
  const [numberOfQ, setNumberOfQ] = React.useState(14);
  const [tot, setTot] = React.useState(10);
  ...
  const SubmitMarks = () => {
    ...
    Toastify("success","Updated marks temporarily!Kindly click on submit button to store permanently!")
    setUp()
  };
